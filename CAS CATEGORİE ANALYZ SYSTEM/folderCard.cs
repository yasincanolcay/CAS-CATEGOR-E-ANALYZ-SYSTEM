...
{
    public partial class folderCard : Form
    {
        ...
        private void folderCard_Load(object sender, EventArgs e)
        {
            writeLabel();
        }
        ...
        private void folderNamelbl_MouseHover(object sender, EventArgs e)
        {
            listCardPAnel.BackColor = Color.FromArgb(0, 80, 120);
        }

        private void folderNamelbl_MouseLeave(object sender, EventArgs e)
        {
            listCardPAnel.BackColor = Color.FromArgb(30, 95, 130);
        }

        private void folderDisklbl_MouseHover(object sender, EventArgs e)
        {
            listCardPAnel.BackColor = Color.FromArgb(0, 80, 120);
        }

        private void folderDisklbl_MouseLeave(object sender, EventArgs e)
        {
            listCardPAnel.BackColor = Color.FromArgb(30, 95, 130);
        }
        ...
        private void klasördeGösterToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand command = new SqlCommand(query, sqlConnection))
            {
                ...
                command.Parameters.AddWithValue("@status","Klasörde Gösterildi");
                sqlConnection.Open();
        ...
        private void openFolderNow()
        {
            ...
            folderCardList.Clear();
            filesCardList.Clear();
            subFolderCardList.Clear();
            ...
            if (directories == null||directories.Length==0&&onlyFiles&&onlyFolders)
            {
                //alt dizindeki dosyalarıda al
